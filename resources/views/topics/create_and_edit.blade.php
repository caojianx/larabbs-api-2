                                ...
                                <form action="{{ route('topics.store') }}" method="POST" accept-charset="UTF-8">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control" type="text" name="title" id="title-field"
                                               placeholder="请填写标题" value="{{ old('title', $topic->title ) }}"/>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <textarea name="body" id="editor" class="form-control" rows="3" required
                                                  placeholder="请填入至少是哪个字符的内容">{{ old('body', $topic->body ) }}</textarea>
                                    </div>
